...
interface AddParentModalProps {
  onClose: () => void;
  onSubmit: (parentData: Omit<Parent, '_id'>) => Promise<void>;
}
...
export default function AddParentModal({ onClose, onSubmit }: AddParentModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSubmit(formData as Omit<Parent, '_id'>);
      setFormData({
        fullName: '',
        email: '',
        password: '',
